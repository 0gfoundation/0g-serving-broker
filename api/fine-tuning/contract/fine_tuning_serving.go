...
// AbandonDeliverable is a paid mutator transaction binding the contract method 0xaa2ad48c.
//
// Solidity: function abandonDeliverable(address user, string id) returns()
func (_FineTuningServing *FineTuningServingTransactor) AbandonDeliverable(opts *bind.TransactOpts, user common.Address, id string) (*types.Transaction, error) {
	return _FineTuningServing.contract.Transact(opts, "abandonDeliverable", user, id)
}

// AbandonDeliverable is a paid mutator transaction binding the contract method 0xaa2ad48c.
//
// Solidity: function abandonDeliverable(address user, string id) returns()
func (_FineTuningServing *FineTuningServingSession) AbandonDeliverable(user common.Address, id string) (*types.Transaction, error) {
	return _FineTuningServing.Contract.AbandonDeliverable(&_FineTuningServing.TransactOpts, user, id)
}

// AbandonDeliverable is a paid mutator transaction binding the contract method 0xaa2ad48c.
//
// Solidity: function abandonDeliverable(address user, string id) returns()
func (_FineTuningServing *FineTuningServingTransactorSession) AbandonDeliverable(user common.Address, id string) (*types.Transaction, error) {
	return _FineTuningServing.Contract.AbandonDeliverable(&_FineTuningServing.TransactOpts, user, id)
}
...
// FineTuningServingDeliverableAbandonedIterator is returned from FilterDeliverableAbandoned and is used to iterate over the raw logs and unpacked data for DeliverableAbandoned events raised by the FineTuningServing contract.
type FineTuningServingDeliverableAbandonedIterator struct {
	Event *FineTuningServingDeliverableAbandoned // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *FineTuningServingDeliverableAbandonedIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(FineTuningServingDeliverableAbandoned)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *FineTuningServingDeliverableAbandonedIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *FineTuningServingDeliverableAbandonedIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// FineTuningServingDeliverableAbandoned represents a DeliverableAbandoned event raised by the FineTuningServing contract.
type FineTuningServingDeliverableAbandoned struct {
	User          common.Address
	Provider      common.Address
...
// FilterDeliverableAbandoned is a free log retrieval operation binding the contract event 0x0d474986f5f081bf0e5f62804cddea0013b65e7bfdf5245ab9e10b285d246d79.
//
// Solidity: event DeliverableAbandoned(address indexed user, address indexed provider, string deliverableId, uint256 timestamp)
func (_FineTuningServing *FineTuningServingFilterer) FilterDeliverableAbandoned(opts *bind.FilterOpts, user []common.Address, provider []common.Address) (*FineTuningServingDeliverableAbandonedIterator, error) {
	...
	logs, sub, err := _FineTuningServing.contract.FilterLogs(opts, "DeliverableAbandoned", userRule, providerRule)
	if err != nil {
		return nil, err
	}
	return &FineTuningServingDeliverableAbandonedIterator{contract: _FineTuningServing.contract, event: "DeliverableAbandoned", logs: logs, sub: sub}, nil
}

// WatchDeliverableAbandoned is a free log subscription operation binding the contract event 0x0d474986f5f081bf0e5f62804cddea0013b65e7bfdf5245ab9e10b285d246d79.
//
// Solidity: event DeliverableAbandoned(address indexed user, address indexed provider, string deliverableId, uint256 timestamp)
func (_FineTuningServing *FineTuningServingFilterer) WatchDeliverableAbandoned(opts *bind.WatchOpts, sink chan<- *FineTuningServingDeliverableAbandoned, user []common.Address, provider []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _FineTuningServing.contract.WatchLogs(opts, "DeliverableAbandoned", userRule, providerRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(FineTuningServingDeliverableAbandoned)
				if err := _FineTuningServing.contract.UnpackLog(event, "DeliverableAbandoned", log); err != nil {
					return err
				}
				event.Raw = log
...
// ParseDeliverableAbandoned is a log parse operation binding the contract event 0x0d474986f5f081bf0e5f62804cddea0013b65e7bfdf5245ab9e10b285d246d79.
//
// Solidity: event DeliverableAbandoned(address indexed user, address indexed provider, string deliverableId, uint256 timestamp)
func (_FineTuningServing *FineTuningServingFilterer) ParseDeliverableAbandoned(log types.Log) (*FineTuningServingDeliverableAbandoned, error) {
	event := new(FineTuningServingDeliverableAbandoned)
	if err := _FineTuningServing.contract.UnpackLog(event, "DeliverableAbandoned", log); err != nil {
		return nil, err
	}
